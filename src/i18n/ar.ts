...
export const ar: typeof en = {
  translation: {
    ...
    audit: {
      ...
      when: 'التوقيت',
      allTypes: 'كل الأحداث',
      allActors: 'كل المسؤولين',
      from: 'من تاريخ',
      to: 'إلى تاريخ',
      empty: 'لا توجد أحداث تدقيق مطابقة للفلاتر الحالية',
      types: {
        ROLE_CHANGED: 'تغيير دور',
        USER_DEACTIVATED: 'تعطيل مستخدم',
        ADMIN_PASSWORD_RESET: 'إعادة تعيين كلمة مرور من المسؤول',
        PASSWORD_RESET_COMPLETED: 'اكتمال إعادة تعيين كلمة المرور',
        REFRESH_TOKEN_REUSE: 'إعادة استخدام رمز التحديث',
      },
    },
    summary: {
      ...
      overdue: 'المتأخرة',
      upcoming: 'القادمة',
      completedEmpty: 'لم تكتمل أي مهمة هذا الأسبوع بعد.',
      overdueEmpty: 'لا توجد مهام متأخرة — أحسنت.',
      upcomingEmpty: 'لا توجد مهام مستحقة هذا الأسبوع.',
    ...
    profile: {
      ...
      photoHint: 'PNG أو JPEG أو WebP أو GIF، بحد أقصى 2 ميغابايت.',
    },
    users: {
      create: 'إنشاء مستخدم',
      edit: 'تعديل مستخدم',
    ...
    savedFilters: {
      saveCurrent: 'حفظ الفلاتر',
      saveTitle: 'حفظ الفلاتر الحالية',
      name: 'الاسم',
      saved: 'تم حفظ الفلاتر',
      remove: 'حذف الفلتر المحفوظ {{name}}',
    },
    checklist: {
      title: 'قائمة التحقق',
      add: 'إضافة',
      progress: 'تقدم قائمة التحقق',
      addPlaceholder: 'أضف بنداً إلى قائمة التحقق…',
    ...
    focus: {
      title: 'تركيز يومي',
      pin: 'تثبيت في التركيز اليومي',
      unpin: 'إزالة من التركيز اليومي',
      pinned: 'تم التثبيت في تركيزك اليومي',
      unpinned: 'تمت الإزالة من تركيزك اليومي',
    },
    tags: {
      title: 'الوسوم',
      add: 'إضافة وسم',
      editTitle: 'تعديل الوسم',
      edit: 'تعديل الوسم {{name}}',
      delete: 'حذف الوسم {{name}}',
      deleteTitle: 'حذف الوسم',
      deleteConfirm: 'حذف "{{name}}"؟ سيُزال من جميع المهام.',
      name: 'الاسم',
      color: 'اللون',
      customColor: 'لون مخصص',
      preview: 'معاينة',
      empty: 'لا توجد وسوم بعد',
      filter: 'تصفية حسب الوسم',
      all: 'كل الوسوم',
    },
    tasks: {
      create: 'إنشاء مهمة',
      edit: 'تعديل مهمة',
      blocked: 'معطّلة',
      markBlocked: 'وضع علامة معطّلة',
      unblock: 'إلغاء التعطيل',
      markedBlocked: 'تم وضع علامة معطّلة على المهمة',
      unblocked: 'تم إلغاء تعطيل المهمة',
      blockReasonLabel: 'ما سبب تعطّل هذه المهمة؟',
      blockedReason: 'معطّلة: {{reason}}',
      title: 'العنوان',
      priority: 'الأولوية',
    ...
    recurring: {
      ...
      occurrences: 'النسخ القادمة من {{title}}',
      occurrencesTitle: 'النسخ القادمة — {{title}}',
      noOccurrences: 'لا توجد نسخ قادمة',
      skip: 'تخطٍّ',
      restore: 'استعادة',
      skipped: 'متخطّاة',
      skipHint: 'تخطي تاريخ واحد لا يؤثر على القاعدة ولا على بقية النسخ.',
    },
    collab: {
      tabs: {
        comments: 'التعليقات',
      ...
      commentPlaceholder: 'اكتب تعليقاً… (@ للإشارة)',
      post: 'نشر',
